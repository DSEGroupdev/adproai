  ...
  return (
    <>
      <div className="max-w-3xl mx-auto p-6">
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">2. Account Responsibility</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">3. Subscription & Billing</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">4. Limitations & Liability</h2>
        <p className="mb-4">
